...
case class ChargingStation(id: Int, status: ChargingStationStatus, location: Point2D):
  def changeState(newState: ChargingStationStatus): ChargingStation = ChargingStation(id, newState, location)
